...
MODULE_PARM_DESC(VERBOSE,
	"Print debug statements to the message buffer, options: [0/1/2]");
...
MODULE_PARM_DESC(INTF_PREFIX, "The prefix of the interface name that should execute the netfilter hooks");
